...
xx11 = 256  # в этом случае переменной x присваивается тип int
# (цлочисленное значение)
...
# нотацию Паскаль, PascalCase (то же самое, только тепер все слова
# пишутся с заглавной)
...
# имени переменной, а вот просто list нельзя.
# -

# ### Ответы на вопросы

# **Вопрос**. Как можно преобразовать список чисел таким образом,
